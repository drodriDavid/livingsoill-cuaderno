...
Write-Host ""
Write-Host "-> Montando fuente.html..." -ForegroundColor DarkGray
python montar.py
if ($LASTEXITCODE -ne 0) { Write-Host "ERROR: fallo montar.py." -ForegroundColor Red; exit 1 }
...
Write-Host ""
Write-Host "Publicado en https://drodridavid.github.io/livingsoill-cuaderno/" -ForegroundColor Green
Write-Host ""
Write-Host "Si has cambiado la clave, borra clave-cuaderno.txt de la carpeta de Drive" -ForegroundColor Yellow
Write-Host "'Cuaderno LivingSoiLL (UJA)' y vuelve a entrar para dejar la nueva." -ForegroundColor Yellow
Write-Host ""
